    ...
    <font color="black" size="4">
        <table class="upper_content_forms_table" >
            <tr>
                ...
                <td align="center"><input id="libelle" type="text" name="libelle" value='<?php if(isset($view['form']['libelle'])) echo$view['form']['libelle'];?>' placeholder="Nom Du Produit"  required>  </td>
                <td width="42px" align="left">Prix</td>   
                <td align="center"><input id="prix" type="text" name="prix" value='<?php if(isset($view['form']['prix'])) echo$view['form']['prix'];?>' placeholder="Prix du produit" required>  </td>
            </tr>
            <tr>
