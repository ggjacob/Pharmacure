	...
	<body style="overflow-x: none;overflow-x: hidden" onload="display_ct();" onload='addTabVentes("Vente","<?=WEBROOT?>Vente/index")'>
		...
		<div id="content">
			...
			<tr style=" min-height:100%; padding:0px; border-spacing: 0px; border-collapse: separate;">
				...
				<span id="copyright" style="position:fixed; bottom:10px; color:white; font-family:arial;"><font size="1"><p>&copy; Copyright 2014. All Rights Reserved </br> Site Created by DGK </p></font></span><div class="mini_logo"></div>
				</td>
