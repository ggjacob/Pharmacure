    ...
    <font color="black" size="4">
        <table class="upper_content_forms_table" >
            <tr>
                ...
                <td align="center"><input id="libelle" type="text" name="libelle" value='<?php if(isset($view['form']['libelle'])) echo$view['form']['libelle'];?>' placeholder="Libelle du fournisseur"  required>  </td>
                <td width="42px" align="left">Adresse</td>   
                <td align="center"><input id="adresse" type="text" name="adresse" value='<?php if(isset($view['form']['adresse'])) echo$view['form']['adresse'];?>' placeholder="adresse du fournisseur" required>  </td>
            </tr>
            <tr>
