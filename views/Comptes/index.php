        ...
        "columnDefs": [
            {
                ...
                return '<a id="infos/'+full["id"]+'" onclick="MyPopUp(this.id,800,230,300,-100)" href="#" class="js__p_start"><div class="view_icon_table" Onclick=""></div></a><a id="modification/'+full["id"]+'" onclick="MyPopUp(this.id,800,270)" href="#" class="js__p_start"><div class="modif_icon_table"></div></a><a id="suppression/'+full["id"]+'" name ="'+full["Login"]+'" onclick="Suppression(this.id, this.name)" href="#" class="js__p_start"><div class="remove_icon_table"></div></a>';
    }
            },
            {
                "targets": [ 1 ],
