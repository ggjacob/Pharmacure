            ...
            <font color="black" size="4">
                <table class="upper_content_forms_table" >
                    <tr>
                        ...
                        <td align="center"><input type="text" name="lastname" placeholder="Nom Du Client">  </td>
                        <td width="42px" align="left">Prenom</td>   
                        <td align="center"><input type="text" name="lastname" placeholder="Prenom Du Client">  </td>
                    </tr>
                    <tr>
                        <td width="42px" align="left">N&deg; Tel</td>   
                        <td align="center"><input type="text" name="lastname" placeholder="Numero De Telephone">  </td>
                        <td width="42px" align="left">Mail</td>   
                        <td align="center"><input type="email" name="lastname" placeholder="Adresse Valide">  </td>
                    </tr>
                </table>
                <textarea name="message"  id="message" cols="50" rows="6" placeholder="Veuillez Taper Un Commentaire"></textarea><br>
