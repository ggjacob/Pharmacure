...
$(function () {
    $('#evol_CA_mois').highcharts({
        chart: {
            zoomType: 'x'
        },
        title: {
            text: 'évolution journalière du CA'
        },
        subtitle: {
            text: 'Août 2014'
        },
...
<table>
	<tr>
		<td>
			<tr>
				<td style="">
					<div id="evol_CA" style="width:450px; height:200px;margin:10px;"></div>
					<div id="evol_CA_mois" style="width:450px; height:200px;margin:10px;"></div>
				</td>
				<td>
					<div id="evol_stock" style="width:450px; height:300px;margin:10px;margin-top:70px"></div>
				</td>
			</tr>
		</td>
	</tr>
